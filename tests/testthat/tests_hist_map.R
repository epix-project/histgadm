...
test_that("`hist_map` returns the correct output", {
  ...
  vn_8082 <- hist_map("Vietnam", vn_province, vn_history, path = FALSE,
  ...
  test5 <- hist_map("France", intlib = FALSE, path = FALSE)
