...
[![AppVeyor build status](https://ci.appveyor.com/api/pruojects/status/github/epix-project/histgadm?branch=master&svg=true)](https://ci.appveyor.com/project/epix-project/histgadm)
